...
public class ItemReceiptReportModel {
	
	private String irLocalNo;
	
	private String irDate;
	
	private int mastRecoNO;
	...
	public int getMastRecoNO() {
		return mastRecoNO;
	}

	public void setMastRecoNO(int mastRecoNO) {
		this.mastRecoNO = mastRecoNO;
	}
