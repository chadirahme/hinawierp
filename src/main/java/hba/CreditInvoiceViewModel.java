...
public class CreditInvoiceViewModel {
	...
	private Logger logger = Logger.getLogger(CreditInvoiceViewModel.class);
	...
	public CreditInvoiceViewModel() {
		...
		{
			logger.error("ERROR in CreditInvoiceViewModel ----> onLoad", ex);
		}
	}
					...
					Messagebox.show("Selected Item have sub Sub Item(s). Do you want to continue?","Credit Invoice", Messagebox.YES | Messagebox.NO  , Messagebox.QUESTION,
						...
						public void onEvent(Event evt) throws InterruptedException {
							...
							{		 
								...
								BindUtils.postNotifyChange(null, null, CreditInvoiceViewModel.this, "lstCashInvoiceCheckItems");
								BindUtils.postNotifyChange(null, null, CreditInvoiceViewModel.this, "toatlAmount");
							}
						}
					...
					Messagebox.show("Selected Class have Sub Class(s). Do you want to continue?","Class", Messagebox.YES | Messagebox.NO  , Messagebox.QUESTION,
						...
						public void onEvent(Event evt) throws InterruptedException {
							...
							{		 
								...
								BindUtils.postNotifyChange(null, null, CreditInvoiceViewModel.this, "selectedInvcCutomerClass");
							}
						}
	...
	{	      
		...
		{	
			...
			if(creditInvoiceKey>0)
			{
				Clients.showNotification("The  Credit Invoice  Has Been Updated Successfully.",
			...
			{
				Clients.showNotification("The Credit Invoice Has Been Created Successfully.",
						Clients.NOTIFICATION_TYPE_INFO, null, "middle_center", 10000,true);
				Borderlayout bl = (Borderlayout) Path.getComponent("/hbaSideBar");
				Center center = bl.getCenter();
				Tabbox tabbox=(Tabbox)center.getFellow("mainContentTabbox");
	...
	public void navigationCreditInvoice(@BindingParam("cmp") String navigation)
	{
		...
		{	
			logger.error("ERROR in CreditInvoiceViewModel ----> navigationCashInvoice", ex);			
		}
	}
	...
	public void copyFunctinality()
	{
		...
		{	
			logger.error("ERROR in CreditInvoiceViewModel ----> copyFunctinality", ex);			
		}
	}
	...
	public void createPdfForPrinting()
	{
		if(validateData(false))
		{
		   ...
		   document.add(paragraph);*/
				...
				logger.error("ERROR in CreditInvoiceViewModel ----> createPdfforprinting()", ex);
			}
		}
	}
	...
	class HeaderFooter extends PdfPageEventHelper {
		...
		public void onEndPage(PdfWriter writer, Document document) {
			...
			try {
				...
				logger.error(
						"ERROR in CreditInvoiceViewModel class HeaderFooter PDf ----> onEndPage",
						e);
	...
	public void previewPdfForprintingInvoice()
	{
		...
		{	
			logger.error("ERROR in CreditInvoiceViewModel ----> previewPdfForprintingInvoice", ex);			
		}
	}
	...
	public void cashInvoiceSetting()
	{
		...
		{	
			logger.error("ERROR in CreditInvoiceViewModel ----> cashInvoiceSetting", ex);			
		}
	}
	...
	public void goToRelatedReport()
	{
		try
		{
			...
			Tab newTab = new Tab();
			newTab.setLabel("Credit Invoice Report");
			newTab.setClosable(true);
			Tabpanel newTabpanel = new Tabpanel();
			Include incContentPage = new Include();
			incContentPage.setSrc("/hba/report/creditINvoiceReport.zul");
		...
		{	
			logger.error("ERROR in CreditInvoiceViewModel ----> goToRelatedReport", ex);			
		}
	}
				...
				public void onEvent(Event evt)
					...
					if (evt.getName().equals("onNo")) {
						try {
							...
							logger.error("ERROR in CreditInvoiceViewModel ----> CustomerSendEmail",ex);
						}
					}
				}
			});
